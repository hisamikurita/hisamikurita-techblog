...
export const META_TITLE = `${SITE_NAME} | クリエイティブ・フロントエンドデベロッパーのプライベートなブログ` as const;
export const META_DESCRIPTION = "東京で働くクリエイティブ・フロントエンドデベロッパーのプライベートな情報発信ブログ" as const;
