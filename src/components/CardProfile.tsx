...
export const CardProfile = ({ className }: Props) => {
  return (
    <div className={cn("w-full", className)}>
      <div className="rounded-t-sm border border-gray-400 px-8 py-6">
        <Image src="/images/me.png" alt="" width={240} height={240} className="mx-auto h-20 w-20 rounded-full object-cover" />
        <h2 className="mt-2 text-center text-sm">くりちゃん</h2>
      ...
      <div className="flex items-center justify-center gap-5 rounded-b-sm bg-primary py-4">
